(function () {
        ...
        function CSVDataSource() {
            ...
            Object.defineProperty(this, '_keysCallbacks', {
                value: newLinkableChild(this, CallbackCollection)
            });
            ...
            Object.defineProperty(this, 'initializationComplete', {
                get: function () {
                    ...
                    return CSVDataSource.prototype.initializationComplete && this._parsedRows && this._keysVector && !WeaveAPI.SessionManager.linkableObjectIsBusy(this._keysCallbacks);
                }
            });
        ...
        function updateKeys(forced = false) {
            forced = (forced === undefined) ? false : forced;
            var changed = WeaveAPI.detectLinkableObjectChange(updateKeys.bin(this), this.keyType, this.keyColName);
        ...
        p.requestColumnFromSource = function (proxyColumn) {
            ...
            if (dataType === null || dataType === DataType.NUMBER) {
                numbers = stringsToNumbers.call(this, strings, dataType === DataType.NUMBER);
            }
        ...
        function getColumnMetadata(id) {
            try {
                ...
                var meta = metadata.getSessionState();
        ...
        function stringsToNumbers(strings, forced) {
            ...
            outerLoop: while (i--) {
                var string = StringUtil.trim(strings[i]);
        ...
        p.initialize = function () {
            ...
            CSVDataSource.prototype.initialize();
        }
        ...
        p.generateMetadataForColumnId = function (id) {
            ...
            metadata[weavedata.ColumnMetadata.KEY_TYPE] = this.keyType.value || DataType.STRING;
        ...
        p.getAttributeColumn = function (metadata) {
            if (typeof metadata != 'object')
                metadata = this.generateMetadataForColumnId(metadata);
            return CSVDataSource.prototype.getAttributeColumn(metadata);
        }
